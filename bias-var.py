...
p1.plot(lbd_seq_2, theory_1[:, 2] / sigma ** 2, label='Var', ls=':', lw=4)
p1.set_xlabel(r'$\lambda$', fontsize=14)
p1.grid(linestyle='dotted')
p1.set_title(r'$\gamma={}$'.format(gamma_1), fontsize=14)

p2 = plt.subplot(122)
p2.plot(lbd_seq_2, theory_2[:, 1] / alpha ** 2, label=r'$Bias^2$', lw=4)
p2.plot(lbd_seq_2, theory_2[:, 2] / sigma ** 2, label='Var', ls=':', lw=4)
...
plt.savefig('./Plots/bias_var_alpha_{}_sigma_{}.png'.format(alpha, sigma))
